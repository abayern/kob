...
export class Snake extends AcGameObject{
    constructor(info, gamemap){
        ...
        this.direction = -1; //没有指令,0,1,2,3表示上右下左
        this.status = "idle";//静止,move表示移动,die表示失败
        ...
        if(this.id === 1) this.eye_direction = 2; // 左下角地蛇初始朝上,右下角地朝下
    ...
    check_tail_increasing(){//检测蛇地长度是否增加
    ...
    next_step(){// 将蛇的状态变为走下一步
        ...
        if(!this.gamemap.check_valid(this.next_cell)){//操作相撞,蛇销毁
            this.status = "die";
        }
    }
